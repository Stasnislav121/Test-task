...
class TestItemId:
    ...
    def test_get_item_without_id(self):
        ...
        with allure.step('Валидация схемы ответа'):
            ResponseHandler.validate_response(response, get_item_not_found_err_schema)
    ...
    def test_get_item_with_invalid_id(self, item_id):
        ...
        with allure.step('Валидация схемы ответа'):
            ResponseHandler.validate_response(response, get_item_err_schema)
    ...
    def test_get_item_boundary_values_id(self, item_id):
        expect_item_id = item_id
        expect_error_text = f'Invalid id'
