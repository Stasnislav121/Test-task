...
class TestItemId:
    ...
    @allure.title('[200] GET /api/1/item/:id - получение информации по объявлению по существующему id')
    def test_get_data_item_by_existing_id(self, add_item):
        ...
        with allure.step('Проверка параметров ответа'):
            ...
            assert actual_entry_datas is True, (f'Ожидалось вхождение {expect_item_data} в {actual_item_data}, '
                                                f'получена разница {actual_entry_datas} по объявлению {expect_item_id}')
